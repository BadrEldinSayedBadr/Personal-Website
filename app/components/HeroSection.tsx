...
export default function HeroSection() {
	...
	return (
		<section className="min-h-screen relative overflow-hidden py-24 md:py-0">
			...
			<div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 pt-1 md:pt-10">
				<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8 md:mb-12">
					<div className="space-y-3 md:space-y-4 mb-6 md:mb-8">
						...
						<p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
							I craft end-to-end solutions with 1+ years of experience building scalable applications and leading development teams.
						</p>
						{/* <p className="text-base md:text-lg text-gray-500 max-w-2xl mx-auto">
							Previously Full Stack Developer at <span className="text-blue-400">Stripe</span> and Tech Lead at{' '}
					...
					<div className="flex flex-wrap justify-center gap-2 md:gap-3 mb-2 md:mb-3">
						...
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-teal-500/10 rounded-full text-teal-400 text-xs md:text-sm">Asp.Net Core</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full text-blue-400 text-xs md:text-sm">C#</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-purple-500/10 rounded-full text-purple-400 text-xs md:text-sm">Sql Server</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full text-blue-400 text-xs md:text-sm">EF Core</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-teal-500/10 rounded-full text-teal-400 text-xs md:text-sm">Agile</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-purple-500/10 rounded-full text-purple-400 text-xs md:text-sm">GitHub</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-blue-500/10 rounded-full text-blue-400 text-xs md:text-sm">Web Api</span>
						<span className="px-3 md:px-4 py-1.5 md:py-2 bg-teal-500/10 rounded-full text-teal-400 text-xs md:text-sm">MVC</span>
					</div>
				</motion.div>
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
							...
							>
								...
								<ul className="space-y-1.5 md:space-y-2 text-xs md:text-sm text-gray-400">
									...
									<li className="flex items-center gap-2">
										<div className="w-1.5 h-1.5 bg-teal-500 rounded-full" />
										Business & VPS Hosting Management
									</li>
									<li className="flex items-center gap-2">
										<div className="w-1.5 h-1.5 bg-teal-500 rounded-full" />
										Website Publishing
